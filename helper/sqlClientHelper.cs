...
namespace R2R.helper
{
    internal class sqlClientHelper
    {
        ...
        public static string sqlString_select = "SELECT * FROM ";
        public static string sqlString_select_alarm = "SELECT * FROM alarm";
        public static string sqlString_select_Users = "SELECT * FROM Users";
        public static string sqlString_select_operation = "SELECT * FROM operation";
        public static string sqlString_clear = "TRUNCATE TABLE ";
        public static string sqlString_clear_alarm = "TRUNCATE TABLE alarm";
        public static string sqlString_clear_Users = "TRUNCATE TABLE Users";
        public static string sqlString_clear_operation = "TRUNCATE TABLE operation";
        public static string vsqlString_getAll_tablename = "SELECT name FROM SysObjects Where XType='U' ORDER BY name";
        public static string sqlString_select_timerange = "SELECT * FROM your_table WHERE your_date_column >= @StartDate AND your_date_column <= @EndDate";
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        ...
        //public static string connectionString = @"Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Program Files (x86)\Maxwell\R2Rsetup\MW_R2R.mdf;Integrated Security = True; Connection Timeout = 30";
        public static string connectionString = @"Data Source = (LocalDB)\MSSQLLocalDB;Integrated Security = True;AttachDbFilename=|DataDirectory|\MW_R2R.mdf;Initial Catalog=MW_R2R; Connection Timeout = 30";
        // Hashtable to store cached parameters
        private static Hashtable parmCache = Hashtable.Synchronized(new Hashtable());

        public static bool createNewTable(string name)
        {

            string sqlString_copy_table = "CREATE TABLE[dbo].[" +
                name +
                "] (" + "\r\n    " +
                ...
                "[limithigh] FLOAT(53)     NULL,\r\n    " +
                "[limitlow] FLOAT(53)     NULL,\r\n    " +
                "[alarmType] NVARCHAR(50)  NULL,\r\n    " +
                "[alarmhigh] FLOAT(53)     NULL,\r\n    " +
            ...
            try
            {
                ExecteNonQuery(CommandType.Text, sqlString_copy_table, null);
            }
            catch (Exception)
            {
                // log 新建表失败
                Operations.addLog("新建表" + name + "失败");
                return false;
            }
            return true;
        }
        ...
        {
            return GetTable(sqlClientHelper.connectionString, cmdTye, cmdText, commandParameters);
        }
        ...
        #endregion
        public static DataTable getresault(DateTime start, DateTime end, string sql_timeRange)
        {
            DataTable dataTable = new DataTable();
            using (SqlConnection connection = new SqlConnection(sqlClientHelper.connectionString))
            {
                SqlCommand command = new SqlCommand(sql_timeRange, connection);
        ...
        #region  使用table更新数据表
        public static int uptate_From_table(DataTable dt, string tablename)
        {
            try
            {
                var NewTable = dt.Copy();
                using (SqlConnection sqlConn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand deleteCmd = new SqlCommand(deleteQuery, sqlConn))
                    {
        ...
        {
            return ExecuteScalar(sqlClientHelper.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(sqlClientHelper.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(sqlClientHelper.connectionString, CommandType.Text, cmdText, commandParameters);
        }
